...
const kb = {
  company: 'IntelLine — разработка кастомных ИИ-агентов для бизнеса. 3+ лет в AI/ML, 50+ внедрений. Специализация: GPT, Claude, Gemini, DeepSeek, Qwen, Mistral, Llama и другие open‑source-модели.',
  solutions: {
    ...
    automation: 'AI-агенты для автоматизации процессов: сквозная автоматизация, обработка документов, интеграция с ERP, контроль исполнения.'
  },
...
function matchKnowledge(text) {
  ...
  const pairs = [
    ...
    { words: ['автоматизац', 'документ', 'erp', 'процесс'], resp: kb.solutions.automation },
