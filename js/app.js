...
const kb = {
  company: 'IntelLine — разработка кастомных ИИ-агентов для бизнеса. 3+ лет в AI/ML, 50+ внедрений. Специализация: GPT-4, Claude, Llama, Mistral, Gemma и open‑source-модели.',
  solutions: {
